...
class GoogleSheetsTest {
  ...
  fun `update rating works`() {
    ...
    val student1Id = studentStorage.createStudent(grade = grade, from = from).value
    val student2Id = studentStorage.createStudent(grade = grade, from = from).value
    val student3Id = studentStorage.createStudent(grade = grade, from = from).value
