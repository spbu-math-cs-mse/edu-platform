...
object Dialogues {
  ...
  fun askGrade(firstName: String, lastName: String): String =
    "Безумно рада нашему с тобой знакомству, $firstName $lastName!\nВ каком классе ты учишься?"

  const val menu: String = "\u2705 Главное меню"

  const val petDog: String =
    "Гав-гав!\n\n" +
  ...
  const val giveFeedback: String =
    "Здесь ты можешь написать все свои мысли по поводу курсов, " + "а я передам это администраторам"
