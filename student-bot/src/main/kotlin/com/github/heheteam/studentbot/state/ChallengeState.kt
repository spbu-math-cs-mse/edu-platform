...
data class ChallengeState(override val context: User, override val userId: StudentId) :
  ...
  override suspend fun intro(
    ...
    updateHandlersController.addDataCallbackHandler { callback ->
      if (callback.data == Keyboards.YES) {
        ...
        val newDeadline =
          ZonedDateTime.now().plusMinutes(2).toLocalDateTime().toKotlinLocalDateTime()
