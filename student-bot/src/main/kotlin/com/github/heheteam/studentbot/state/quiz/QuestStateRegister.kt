...
inline fun DefaultBehaviourContextWithFSM<State>.registerQuest(
  ...
  registerStateWithStudentId<L1S1Wrong, StudentApi>(studentApi, initUpdateHandlers)
  ...
  registerStateWithStudentId<L1S31, StudentApi>(studentApi, initUpdateHandlers)
  registerStateWithStudentId<L1S3Wrong, StudentApi>(studentApi, initUpdateHandlers)
