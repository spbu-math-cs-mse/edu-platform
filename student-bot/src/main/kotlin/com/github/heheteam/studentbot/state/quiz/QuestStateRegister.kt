...
//  noinline initUpdateHandlers: (UpdateHandlersControllerDefault<out Any>, User, UserId) -> Unit =
//    { _, _, _ ->
//    },
// ) {
//
...
//    initUpdateHandlers,
//  )
//  registerStateForBotStateWithHandlersAndUserId<L1S4Wrong<ApiService, UserId>, ApiService,
// UserId>(
//    studentApi,
//    initUpdateHandlers,
//  )
