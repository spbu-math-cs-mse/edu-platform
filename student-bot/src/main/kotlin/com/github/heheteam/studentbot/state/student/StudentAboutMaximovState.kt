...
class StudentAboutMaximovState(override val context: User, override val userId: StudentId) :
  ...
  override suspend fun intro(
    ...
    bot.sendMessage(
      context,
      "\uD83D\uDC36 Дуся:" +
        "\"Можете теперь посмотреть видео от Вадима или перейти узнать подробнее о курсе.\"",
      replyMarkup = ParentKeyboards.defaultKeyboard(includeKamen = true),
    )
