...
fun Problem.getSeries(series: MutableList<Series>): Series? = series.find { it.id == seriesId }

fun Series.getCourse(courses: MutableList<Course>): Course? = courses.find { it.id == courseId }
