...
import Problem
import com.github.heheteam.teacherbot.buildMock
import com.github.heheteam.teacherbot.getCourse
import com.github.heheteam.teacherbot.getSeries
...
fun DefaultBehaviourContextWithFSM<BotState>.strictlyOnCheckGradesState(gradeTable: GradeTable) {
    strictlyOn<CheckGradesState> { state ->
        ...
        val courses =
            gradeTable
                ...
                .filter { it -> it.teachers.map { it.id }.contains(teacherId) }
                .associateBy { it.id }
        // ---
